...
public class UserController {
    ...
    @PostMapping
    public String userSubmit(@RequestParam("userId") User user, @RequestParam Map<String, String> form,  @RequestParam String username){

//        User user = userRepo.findById(Integer.parseInt(id)).orElse(new User());
